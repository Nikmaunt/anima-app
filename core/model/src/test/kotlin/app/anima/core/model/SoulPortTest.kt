...
class SoulPortTest {
    ...
    private val stats = RelationshipStats(
        hatchedAtMillis = 0L,
    ...
    fun `export is readable markdown with counters and categories`() {
        val md = SoulPort.export(
            ...
            facts = listOf(
                ...
                SoulFact("f-3", FactCategory.PREFERENCE, "hates mornings", FactSource.CHAT_CONFIRMED, 0L,
    ...
    fun `export import roundtrip preserves live facts as candidates`() {
        ...
        assertThat(candidates.map { it.text }).containsAtLeast(
            "my person is Nick", "loves rain", "ships Android apps",
        )
