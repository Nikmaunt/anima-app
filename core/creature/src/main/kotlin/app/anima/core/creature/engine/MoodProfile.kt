...
data class MoodProfile(
    ...
    companion object {
        fun of(mood: Mood): MoodProfile =
            when (mood) {
                Mood.ALERT ->
                    MoodProfile(
                        energy = 1f,
                        breathsPerMinute = 12f,
                        breathDepth = 1f,
                        lidClosure = 0f,
                        dartIntervalSeconds = 3.5f,
                        wanderAmplitude = 0.015f,
                        jitter = 0f,
                        blinkRateScale = 1f,
                    )
                Mood.BORED ->
                    MoodProfile(
                        energy = 0.55f,
                        breathsPerMinute = 10f,
                        breathDepth = 1.1f,
                        lidClosure = 0.3f,
                        dartIntervalSeconds = 7f,
                        wanderAmplitude = 0.01f,
                        jitter = 0f,
                        blinkRateScale = 0.8f,
                    )
                Mood.SLEEPY ->
                    MoodProfile(
                        ...
                        breathDepth = 1.15f,
                        lidClosure = 0.6f,
                        dartIntervalSeconds = 10f,
                        wanderAmplitude = 0.007f,
                        jitter = 0f,
                        blinkRateScale = 0.6f,
                    )
                Mood.EATING ->
                    MoodProfile(
                        ...
                        breathDepth = 1.05f,
                        lidClosure = 0.25f,
                        dartIntervalSeconds = 5f,
                        wanderAmplitude = 0.012f,
                        jitter = 0f,
                        blinkRateScale = 0.9f,
                    )
                Mood.ANXIOUS ->
                    MoodProfile(
                        energy = 1.2f,
                        breathsPerMinute = 24f,
                        breathDepth = 0.6f,
                        lidClosure = 0f,
                        dartIntervalSeconds = 1.6f,
                        wanderAmplitude = 0.02f,
                        jitter = 0.6f,
                        blinkRateScale = 1.4f,
                    )
                Mood.ASLEEP ->
                    MoodProfile(
                        ...
                        breathDepth = 1.3f,
                        lidClosure = 1f,
                        dartIntervalSeconds = 0f,
                        wanderAmplitude = 0.004f,
                        jitter = 0f,
                        blinkRateScale = 0f,
                    )
                Mood.HOT ->
                    MoodProfile(
                        energy = 0.7f,
                        breathsPerMinute = 26f,
                        breathDepth = 0.5f,
                        lidClosure = 0.45f,
                        dartIntervalSeconds = 6f,
                        wanderAmplitude = 0.008f,
                        jitter = 0.25f,
                        blinkRateScale = 0.7f,
                    )
            }
