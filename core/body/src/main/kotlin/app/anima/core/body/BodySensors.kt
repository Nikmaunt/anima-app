...
class BodySensors
    ...
    constructor(
        ...
        fun net(): Flow<NetSense> =
            callbackFlow {
                val cm = context.getSystemService(ConnectivityManager::class.java)

                fun senseOf(caps: NetworkCapabilities?): NetSense =
                    when {
        ...
        fun thermal(): Flow<ThermalSense> =
            callbackFlow {
                val pm = context.getSystemService(PowerManager::class.java)

                fun map(status: Int): ThermalSense =
                    when (status) {
