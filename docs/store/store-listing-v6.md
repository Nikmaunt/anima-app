...
| "speaks your language out of the box" (v5) | ⚠️ ПАК ПУСТ в этом билде (ADR-018 исход 3: артефакт не произведён — блокер среды). Формулировку смягчить до "speaks your language once the mind model is downloaded" ЛИБО не сабмитить, пока владелец не прогонит convert.sh и §0 чеклиста v6 | ⚠️ ГЕЙТ САБМИТА |
