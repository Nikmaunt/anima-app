...
> **АДДЕНДУМ v0.8 (2026-07-25) — СТАТУС: UNVERIFIED.**
> Вывод «исключение 50(1) „очевидно из контекста“ к Anima применимо» —
> **юридическая интерпретация, а не установленный факт**, и юристом она
> не верифицирована. Прогон v0.7 использовал её в отчёте как основание;
> настоящим она переводится в UNVERIFIED целиком, вместе со следствием
> «отдельная строка про ИИ — лишь дешёвая страховка».
> Что здесь ФАКТ (даты, тексты статей, ссылки ниже) — остаётся фактом.
> Что здесь ВЫВОД о применимости к нашему продукту — гипотеза до
> заключения юриста. Решение о явной ИИ-маркировке в онбординге
> принимает владелец, и «исключение применимо» не должно быть
> единственным основанием этого решения.
